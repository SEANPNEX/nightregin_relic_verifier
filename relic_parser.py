...
ALLOWED_DEEP_PAIRED_BUFFS = {
    ...
    6002601, 6002700, 6002701, 6002800, 6002801, 6002900, 6002901, 6003000, 6003100, 6003200, 6003300,
    6003400, 6003500, 6003600, 6005600, 6005601, 6030200, 6030600, 6030800, 6030900, 6030901, 6035100,
    6040100, 6040101, 6040300, 6040400, 6040500, 6043100, 6060300, 6060400, 6060500, 6060600, 6090000,
    6160000, 6260000, 6260001, 6260300, 6260301, 6260400, 6260401, 6500000, 6500100, 6500200, 6500300,
    6500400, 6500500, 6500600, 6500700, 6500800, 6500900, 6600001, 6600101, 6610400, 6610500, 6610600,
    6610700, 6610800, 6610801, 6610802, 6611001, 6611002, 6611100, 6611101, 6611102, 6611200, 6611201,
    6611202, 6611300, 6611301, 6611302, 6611400, 6621000, 6621100, 6621200, 6621300, 6621400, 6621500,
    6621600, 6621700, 6621800, 6621900, 6622000, 6622100, 6622200, 6622300, 6622400, 6622600, 6622700,
    6622900, 6623000, 6623100, 6623200, 6624000, 6624100, 6624200, 6624300, 6624400, 6624500, 6630000,
    6630100, 6630200, 6630300, 6630400, 6630500, 6630600, 6630700, 6630800, 6630900, 6631000, 6631200,
    6631300, 6631400, 6631500, 6631600, 6631700, 6631800, 6631900, 6632000, 6632100, 6632200, 6632300,
    6632400, 6632500, 6632600, 6632700, 6632800, 6632900, 6633000, 6633100, 6640000, 6640100, 6641000,
    6641100, 6642000, 6642100, 6643000, 6643100, 6644000, 6644100, 6645000, 6645100, 6646000, 6646100,
    6647000, 6647100, 6647200, 6647300, 6647400, 6647500, 7000090, 7001002, 7001402, 7001502, 7001602,
    7001702, 7001802, 7002600, 7002700, 7002800, 7002900, 7003000, 7003100, 7003200, 7003300, 7003400,
    7003500, 7003600, 7005600, 7010200, 7012200, 7012300, 7030200, 7030600, 7030700, 7030800, 7031900,
    7035100, 7036100, 7040000, 7040100, 7040300, 7040400, 7040500, 7043100, 7043200, 7043300, 7043400,
    7043500, 7043600, 7043700, 7043800, 7044000, 7044100, 7044200, 7044300, 7044400, 7044500, 7044600,
    7050000, 7050100, 7070000, 7080000, 7080100, 7080200, 7080300, 7080600, 7081000, 7081500, 7081800,
    7082000, 7082500, 7082600, 7082700, 7082800, 7090000, 7090100, 7100100, 7110000, 7120900, 7121000,
    7150000, 7160000, 7230000, 7240000, 7260000, 7260300, 7260400, 7331500, 7331900, 7332000, 7340000,
    7340100, 7340200, 7340300, 7340400, 7340500, 7340600, 7340700, 7340900, 7341100, 7341400, 7341500,
    7341800, 7342000, 7342100, 7342200, 7342300, 7342400, 7350000, 7350100, 7350300, 7350400, 7350500,
    7350600, 7351100, 7351200, 7351400, 7351500, 7351800, 7351900, 7352400
}
...
class RelicLegalityChecker:
    ...
    def _check_with_rule(self, rules, raw_slots):
        ...
        if len(neg_ids) > 0:
            for pos in pos_ids:
                if pos not in ALLOWED_DEEP_PAIRED_BUFFS:
                    return {"status": "Illegal", "reason": f"Buff {pos} cannot be paired with negative effects"}
